...
* The original package name 'com.example.cats-api' is invalid and this project uses 'com.example.cats_api' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/3.2.11/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
