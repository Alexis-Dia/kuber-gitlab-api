...
### внешний URL GitLab-а
external_url "https://elinext-ai-gitlab.tech"

### встроенный nginx GitLab-а: только локально, без TLS
nginx['listen_addresses'] = ['127.0.0.1']
nginx['listen_port']      = 8181
nginx['listen_https']     = false

### выключаем встроенный Let's Encrypt GitLab-а (TLS будет во внешнем nginx)
letsencrypt['enable'] = false

### GitLab понимает, что снаружи https
nginx['proxy_set_headers'] = {
  "X-Forwarded-Proto" => "https",
  "X-Forwarded-Ssl"   => "on"
}

### KAS общается с GitLab по http внутри
gitlab_kas['gitlab_address'] = 'http://127.0.0.1:8181'
# gitlab_kas['enable'] = true  # если вдруг ты его отключал
...
# внешний URL реестра (как он будет виден в GitLab и в CI)
registry_external_url 'https://elinext-ai-gitlab.tech:5050'

# Настройки для Rails-приложения GitLab
gitlab_rails['registry_enabled'] = true
gitlab_rails['registry_host']    = 'elinext-ai-gitlab.tech'
gitlab_rails['registry_port']    = '5050'
gitlab_rails['registry_path']    = '/var/opt/gitlab/gitlab-rails/shared/registry'

# Сам docker-registry
registry['enable']            = true
registry['registry_http_addr'] = 'localhost:5000'  # дефолт для Omnibus

# nginx, который фронтит Registry внутри GitLab
registry_nginx['enable'] = true
# слушаем 5050 с HTTPS, как и раньше
# (порт 5050 ВНЕШНИМ nginx НЕ занимаем!)
# по умолчанию он и так 5050, но можно явно:
# registry_nginx['listen_port']   = 5050
# registry_nginx['listen_https']  = true

# говорим, какие сертификаты использовать (у тебя они уже есть)
registry_nginx['ssl_certificate']     = '/etc/gitlab/ssl/elinext-ai-gitlab.tech.crt'
registry_nginx['ssl_certificate_key'] = '/etc/gitlab/ssl/elinext-ai-gitlab.tech.key'
